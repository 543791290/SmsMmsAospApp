...
//        }
    ...
    private void handleServiceStateChanged(Intent intent) {
        ...
        /*aaron TODO ServiceState serviceState = ServiceState.newFromBundle(intent.getExtras());
        if (serviceState.getState() == ServiceState.STATE_IN_SERVICE) {
            sendFirstQueuedMessage();
        }*/
    	
    	 Log.e(TAG, "aaron error to run here");
    }
    ...
    private void handleSmsSent(Intent intent, int error) {
        ...
        if (mResultCode == Activity.RESULT_OK) {
            ...
            if (!Utils.moveMessageToFolder(this, uri, Sms.MESSAGE_TYPE_SENT, error)) {
            ...
            Utils.moveMessageToFolder(this, uri, Sms.MESSAGE_TYPE_QUEUED, error);
        ...
        } else if (mResultCode == 6/*aaron TODO SmsManager.RESULT_ERROR_FDN_CHECK_FAILURE*/) {
    ...
    private void messageFailedToSend(Uri uri, int error) {
        ...
        Utils.moveMessageToFolder(this, uri, Sms.MESSAGE_TYPE_FAILED, error);
    ...
    private Uri replaceMessage(Context context, SmsMessage[] msgs, int error) {
        ...
        if (pduCount == 1) {
            ...
            for (int i = 0; i < pduCount; i++) {
                sms = msgs[i];
                /*aaron TODOif (sms.mWrappedSmsMessage != null) {
...
//    private static int count = 0;
    ...
    private Uri storeMessage(Context context, SmsMessage[] msgs, int error) {
        ...
        if (pduCount == 1) {
            ...
            for (int i = 0; i < pduCount; i++) {
                sms = msgs[i];
               /*aaron TODO if (sms.mWrappedSmsMessage != null) {
                    body.append(sms.getDisplayMessageBody());
                }*/
            }
            values.put(Inbox.BODY, replaceFormFeeds(body.toString()));
