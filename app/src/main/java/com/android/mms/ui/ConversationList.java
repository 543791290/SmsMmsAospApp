...
public class ConversationList extends ListActivity implements DraftCache.OnDraftChangedListener {
    ...
    protected void onResume() {
        ...
        Log.d(TAG,"mIsSmsEnabled = " + mIsSmsEnabled);
            ...
            public void run() {
                if (Recycler.checkForThreadsOverLimit(ConversationList.this)) {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            /*aaron TODO Intent intent = new Intent(ConversationList.this,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (cellBroadcastItem != null) {
            ...
            boolean isCellBroadcastAppLinkEnabled = false;/*aaron TODO this.getResources().getBoolean(
